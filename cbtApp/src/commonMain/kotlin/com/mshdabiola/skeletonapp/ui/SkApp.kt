...
import com.mshdabiola.mainc.navigation.MAIN_ROUTE
import com.mshdabiola.mainc.navigation.navigateToMain
...
fun SkeletonApp() {
    ...
    val navigator: (String) -> Unit = {
        ...
        when (it) {
            ...
            PROFILE_ROUTE -> {
                appState.navController.navigateToProfile(navOptions = navOptions {
                    this.launchSingleTop =true
                    this.restoreState=true
            ...
            STAT_ROUTE -> {
                appState.navController.navigateToStat(navOptions = navOptions {
                    this.launchSingleTop =true
                    this.restoreState=true
