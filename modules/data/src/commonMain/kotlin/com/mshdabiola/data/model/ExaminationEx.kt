...
fun Instruction.asEntity() = InstructionEntity(id, examId, title, content)

fun InstructionEntity.asModel() = Instruction(id, examId, title, content)
...
fun Question.asModel() = QuestionEntity(
    id, number, examId, title, contents, answers, isTheory, instruction?.id, topic?.id
)
...
fun QuestionFull.asModel() = Question(
    ...
    contents = questionEntity.contents,
