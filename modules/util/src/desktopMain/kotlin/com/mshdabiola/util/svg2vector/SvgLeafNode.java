...
import static com.mshdabiola.util.svg2vector.Svg2Vector.*;
...
class SvgLeafNode extends SvgNode {
     ...
     */
    private void writeAttributeValues(OutputStreamWriter writer, String indent)
            throws IOException {
    ...
    private SvgGradientNode getGradientNode(String svgValue) {
    ...
    public void transformIfNeeded(AffineTransform rootTransform) {
        ...
        VdPath.Node[] nodes = PathParser.parsePath(mPathData, PathParser.ParseMode.SVG);
